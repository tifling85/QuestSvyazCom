...
CalcServAsyncIO.py - переписанный сервер с добавлением асинхронности с помощью фреймворка AsyncIO. Утрачена многопоточность

CalcFuncAsyncIO.py - переписаны функции под AsyncIO, теперь они корутины
